...
if (!$conn) {
    ...
    $query = "select works.code, works.name, works.created_at, works.id from works where user_id is null;";
...
<div class="medio">
            <nav class="medio_ajuste">
                ...
                <a class="item_a" href="./obras_sin_responsable.php">
                <div class="items">
                    <span class="item_span"> Obras sin responsable </span>
                </div>
                </a>
...
<!--tables with data-->
        ...
        for ($i = 0; $i < $num_filas; $i++) {
            ...
            print "<tr><td>" . trim($resultado['code']) . " </td><td> " . trim($resultado['name']) . "</td><td>" . $resultado['created_at'] . "</td>
                        <td><form action='obras_responsable_conf.php' method='GET'>
