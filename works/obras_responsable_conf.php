...
if (isset($_REQUEST['delete'])) {
    ...
    echo "<script language='javascript'>
            ...
            window.location.replace('./obras_sin_resposanble.php');
        </script>";
    ...
    $query = "select works.code, works.name, works.created_at, works.id from works where works.id=$id_work ;";
    $consulta = mysqli_query($conn, $query) or die("Fallo en la consulta");
    ...
    print '
        ...
        <form action="obras_responsable_edit_save.php" method="GET">
            ...
            Responsable: <br><input type="search" name="buscar_email" list="lista_emails" ><br>
